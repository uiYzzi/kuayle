...
<div class="h-full">
	...
	{#if !loading && views.length === 0}
		<EmptyState
			title={i18n.t('views.no_personal_views')}
			description={i18n.t('views.no_personal_views_desc')}
		/>
	{:else}
	...
	<AlertDialog.Content>
		<AlertDialog.Header>
			...
			<AlertDialog.Description>
				{i18n.t('views.delete_desc', { name: pendingDeleteView?.name ?? '' })}
			</AlertDialog.Description>
		</AlertDialog.Header>
		<AlertDialog.Footer>
